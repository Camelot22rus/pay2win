          ...
          <Accordion>
            ...
            <AccordionDetails>
              <Typography>
                ...
                Добавление или удаление новых игр осуществляется только с аккаунта администратора (Логин: test@test.ru, Пароль: testtest).<br/>С него же происходит модерация предложений о продаже.<br/><br/>
